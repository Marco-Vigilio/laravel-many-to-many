    ...
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <div class="mb-3">
                ...
                <input class="form-check-input" type="checkbox" name="technology_id[]" id="technology_id" value="{{$technology->id}}" @if(in_array($technology->id, old('technologies', [])) ) @checked @endif>
